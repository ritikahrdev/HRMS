    ...
    return '<div class="job" id="job-' + j.id + '" style="animation-delay:' + (i * 80) + 'ms">' +
      ...
      '<form data-job="' + j.id + '" enctype="multipart/form-data">' +
        '<div class="grid">' +
          ...
          '<div><label>Years of Experience *</label><input name="experience_years" type="number" min="0" max="50" step="0.5" required /></div>' +
          '<div class="full"><label>Your Key Skills (comma separated) *</label><input name="skills" required maxlength="500" placeholder="e.g. React, Node.js, SQL" /></div>' +
          '<div class="full"><label>Resume (PDF/DOC) *</label><input name="resume" type="file" accept=".pdf,.doc,.docx,.png,.jpg,.jpeg" required /></div>' +
          '<div class="full"><label>Why you? *</label><textarea name="note" rows="3" required maxlength="1000" placeholder="A line or two about why you\'d be great for this role"></textarea></div>' +
        '</div>' +
